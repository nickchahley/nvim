...
let colors_name = "material-monokai-edit"
...
" Palettes
" --------
" changed black #263238 >> #282a36
" changed darkblack 1f292d >> 242530
" darkblack = 1 monochrom darker black
" ** need to change airline theme as well **

let s:white       = { "gui": "#CDD3DE", "cterm": "253" }
let s:black       = { "gui": "#282a36", "cterm": "235" }
let s:lightblack  = { "gui": "#2D2E27", "cterm": "234" }
let s:lightblack2 = { "gui": "#383a3e", "cterm": "236" }
let s:darkblack   = { "gui": "#242530", "cterm": "233" }
...
call s:h("CursorLineNr",  { "fg": s:aqua,       "bg": s:black })
